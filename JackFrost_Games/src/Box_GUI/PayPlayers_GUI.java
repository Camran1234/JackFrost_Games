 ...
 * @author camran
 */
public class PayPlayers_GUI {
    
    
    public PayPlayers_GUI(Box box){
        initComponents(box);
    }
    
    public PayPlayers_GUI(Card card){
        initComponents(card);
    }
    ...
    private void initComponents(Box box){
        ...
        JLabel labelInformativo = new JLabel("Precio a pagar a cada Jugador:");
