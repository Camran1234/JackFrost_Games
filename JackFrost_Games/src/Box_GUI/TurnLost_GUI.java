 ...
 * @author camran
 */
public class TurnLost_GUI {
    
    public TurnLost_GUI(Box box){
        initComponents(box);
    }
    
    public TurnLost_GUI(Card box){
        initComponents(box);
    }
    ...
    private void initComponents(Box box){
        ...
        JLabel labelInformativo = new JLabel("Turnos Perdidos:");
        JTextField textField = new JTextField ();
        JButton button = new JButton("Crear");
        button.addActionListener(new ActionListener(){
           public void actionPerformed(ActionEvent a){
               try{
               CardTurn card = new CardTurn(Integer.parseInt(textField.getText().toString()));
               box.add(card);
